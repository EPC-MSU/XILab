...
void command_add_sync_in_action(command_add_sync_in_action_t s) const;
void command_add_sync_in_action_calb(command_add_sync_in_action_calb_t s, calibration_t calb) const;
